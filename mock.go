...
type ResponseParser interface {
	...
	ParseResponse(caller Caller, resp *http.Response, result interface{}) (*Response, error)
}
...
func (p *DefaultResponseParser) ParseResponse(caller Caller, resp *http.Response, result interface{}) (*Response, error) {
